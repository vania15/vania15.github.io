!function (e, t, a) {
    ...
    }, U.x64hash128 = l, U.VERSION = "2.0.6", U
});
!function (e, n, t) {
    "use strict";

    function r() {
        for (var e = 1; e < arguments.length; e++) for (var n in arguments[e]) arguments[e].hasOwnProperty(n) && (arguments[0][n] = arguments[e][n]);
        return arguments[0]
    }
    ...
    function a() {
        return Math.max(n.documentElement.scrollHeight, n.body.scrollHeight, n.documentElement.offsetHeight, n.body.offsetHeight, n.documentElement.clientHeight)
    }

    function l() {
        return e.innerHeight || n.documentElement.clientHeight || n.body.clientHeight
    }

    function u() {
        return e.pageYOffset || ("CSS1Compat" === n.compatMode ? n.documentElement.scrollTop : n.body.scrollTop)
    }

    function c(e) {
        return e.getBoundingClientRect().top + u()
    }

    function f(r) {
        return "undefined" != typeof e.jQuery ? e.jQuery(r).get(0) : "undefined" != typeof n.querySelector ? n.querySelector(r) : "#" == r.charAt(0) ? n.getElementById(r.substr(1)) : t
    }
    ...
    function s(e, n, t) {
        e.removeEventListener ? e.removeEventListener(n, t, !1) : e.detachEvent ? e.detachEvent("on" + n, t) : e["on" + type] = null
    }
    ...
    var v, m, d, y, D, E = {
        ...
        function t(n, t, r, o) {
            ...
            }), S.pixelDepth && arguments.length > 2 && r > T && (T = r, y({
                event: "ScrollDistance",
                eventCategory: "Scroll Depth",
        ...
        function g(e, n, r) {
            for (var i in e) if (e.hasOwnProperty(i)) {
                var a = e[i];
                !o(I, i) && n >= a && (t("Percentage", i, n, r), I.push(i))
            }
        }
        ...
        function s(e, n, r) {
            for (var i = 0; i < e.length; i++) {
                var a = e[i];
                if (!o(I, a)) {
                    var l = "string" == typeof a ? f(a) : a;
                    if (l) {
                        var u = c(l);
                        n >= u && (t("Elements", a, n, r), I.push(a))
                    }
                }
            }
        }
        ...
        function H(e, n) {
            ...
            return function () {
                ...
                a || (a = u);
                var c = n - (u - a);
                return t = this, r = arguments, 0 >= c ? (clearTimeout(i), i = null, a = u, o = e.apply(t, r)) : i || (i = setTimeout(l, c)), o
            }
        }

        var _ = +new Date;
        S = r({}, E, n), a() < S.minHeight || (S.gaGlobal ? (v = !0, d = S.gaGlobal) : "function" == typeof ga ? (v = !0, d = "ga") : "function" == typeof __gaTracker && (v = !0, d = "__gaTracker"), "undefined" != typeof _gaq && "function" == typeof _gaq.push && (m = !0), "function" == typeof S.eventHandler ? y = S.eventHandler : "undefined" == typeof dataLayer || "function" != typeof dataLayer.push || S.gtmOverride || (y = function (e) {
            dataLayer.push(e)
        }), D = H(function () {
            var e = a(), n = l(), t = u() + n, r = i(e), o = +new Date - _;
            return I.length >= 10 + S.elements.length ? void h() : (S.elements && s(S.elements, t, o), void(S.percentage && g(r, t, o)))
        }, 500), p(D))
    }, _ = function () {
        I = [], T = 0, "undefined" != typeof D && (h(D), p(D))
    }, x = function (e) {
        if ("undefined" != typeof e && i(e)) {
            for (var n = 0; n < e.length; n++) {
                var t = e[n], r = S.elements.indexOf(t);
                -1 == r && S.elements.push(t)
            }
            b || p()
        }
    }, L = function (e) {
        if ("undefined" != typeof e && i(e)) for (var n = 0; n < e.length; n++) {
            var t = e[n], r = S.elements.indexOf(t);
            r > -1 && S.elements.splice(r, 1);
            var o = I.indexOf(t);
            o > -1 && I.splice(o, 1)
        }
    };
    e.gascrolldepth = {
        ...
        addElements: x,
        removeElements: L
    }, "undefined" != typeof e.jQuery && (e.jQuery.gascrolldepth = H)
}(window, document);
...
(function () {
    ...
    var sdOptions = {
        pixelDepth: false, eventHandler: function (data) {
            window.userData.document.scroll[data.eventLabel] = data.eventTiming
        },
    };
